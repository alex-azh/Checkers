...
{
    public static readonly uint QueenPositions = UintHelper.CreateNumber(28, 29, 30, 31);
    public static readonly Dictionary<uint, uint> Steps = new()
{
    ...
    public static readonly Dictionary<uint, uint> StepsBackward = new()
    {
    ...
    public static readonly Dictionary<uint, uint> KillsBackward = new()
    {
    ...
    public static readonly Dictionary<uint, uint> StepsByDirection = new()
{
