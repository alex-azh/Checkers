...
//            (21,30,26)
//        };
//        var killsOfJulia = doska.WhitePKills_old().Select(x => CheckerBoard.KillOutput(doska, x)).ToList();
...
//        };
//        var l = doska.WhitePKills_old().Select(x => CheckerBoard.KillOutput(doska, x)).ToList();
...
//             (11, 14, 0)
//        };
//        var all = doska.Variants_old().Select(x => CheckerBoard.KillOutput(doska, x)).ToList();
//        var l = doska.VariantsP().Select(x => CheckerBoard.KillOutput(doska, x)).ToList();
