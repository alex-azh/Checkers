...
public class KillsTests
{
    ...
    public void Test1()
    {
        ...
        List<(int pos, int hod, int dead)> result = doska.Moves().Select(x => Board.WhoMoved(doska, x)).ToList();
    ...
    public void Test2()
    {
        ...
        List<(int fromPos, int toPos, int killedPos)> result = doska.Moves().Select(x => Board.WhoMoved(doska, x)).ToList();
        Console.WriteLine(string.Join("\n", result));
        CollectionAssert.AreEquivalent(actual, result);
    }
    [TestMethod]
    public void Test3()
    {
        ...
        List<(int fromPos, int toPos, int killedPos)> l = doska.Moves().Select(x => Board.WhoMoved(doska, x)).ToList();
